...
x_test_v=variance_model.fit_transform(x_test)
x_train_v=variance_model.transform(x_train)
#数据标准化
standard_model=StandardScaler()
x_test_standard=standard_model.fit_transform(x_test_v)
x_train_standard=standard_model.transform(x_train_v)
